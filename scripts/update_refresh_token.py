...
scope = urllib.parse.quote_plus('playlist-modify-public playlist-modify-private user-read-recently-played')
...
print(f'Head to the {uri_for_access_code} and copy the link you was redirected to after agreeing')
...
refresh_token = json.loads(subprocess.check_output(curl_for_refresh_token, shell=True))['refresh_token']
